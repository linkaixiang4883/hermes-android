...
void main() {
  ...
  test('Gradle and CI enforce the accepted APK upgrade floor', () {
    ...
    expect(releaseWorkflow, contains("REQUIRED_BASE_VERSION_CODE: '2143'"));
    ...
    expect(qualityWorkflow, contains("REQUIRED_BASE_VERSION_CODE: '2143'"));
  });
}
